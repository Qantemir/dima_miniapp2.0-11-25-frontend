...
const STATUS_TIPS = [
  {
    title: 'Принят',
    text: 'После проверки оплаты и чека переключите заказ в «Принят». Клиент получит уведомление, что заказ принят и будет доставлен в течение 2 часов.',
  },
  {
    title: 'Отказано',
    text: 'Если заказ не может быть выполнен, выберите «Отказано» и обязательно укажите причину отказа. Система автоматически вернет товары на склад.',
  },
];
