            ...
            <div className="mt-2 space-y-3">
              <div className="text-sm">
                ...
                <p className="text-muted-foreground">
                  После проверки оплаты и чека переключите заказ в «Принят». Клиент получит уведомление, что заказ принят. Таксист свяжется с клиентом для уточнения деталей доставки.
                </p>
              </div>
              <div className="text-sm">
